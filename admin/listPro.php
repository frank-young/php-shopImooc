...
<div class="details">
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php $i=1; foreach($rows as $row): ?>
                            ...
                            <td><input type="checkbox" id="<?php echo $row['id'];?>" class="check" value="<?php echo $row['id'];?>" >
                            <label for="c1" class="label"><?php echo $i;?></label></td>
                 ...
                 <!-- 这是一个循环 -->
					...
					<table class="table" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td>
								<?php echo $row['pNum'];?></td>
						</tr>
						<tr>
							<td  width="20%"  align="right">商品价格</td>
							<td>
								<?php echo $row['mPrice'];?></td>
						</tr>
						<tr>
							<td  width="20%"  align="right">幕课网价格</td>
							<td>
								<?php echo $row['iPrice'];?></td>
						</tr>
						<tr>
							...
							<?php 
	            				...
	            				?>                                				
								<img width="100" height="100" src="uploads/<?php echo trim($img['albumPath']);?>" alt=""/> &nbsp;&nbsp;
								<?php endforeach;?></td>
						</tr>
						<tr>
							<td width="20%"  align="right">是否上架</td>
							<td>
								<?php echo $row['isShow']==1?"上架":"下架";?></td>
						</tr>
						<tr>
							<td width="20%"  align="right">是否热卖</td>
							<td>
								<?php echo $row['isHot']==1?"热卖":"正常";?></td>
						</tr>
					</table>
					<span style="display:block;width:80%; ">
					商品描述
					<br/>                                				
					<?php echo $row['pDesc'];?></span>
				</div>
				 <?php  $i++; endforeach; ?>
